...
enum {
	...
	MYSQL_CLIENT_NO_SCHEMA = 16,                  /* Dont allow database.table.column */
	...
	MYSQL_CLIENT_SECURE_CONNECTION = 32768, 	  /* New 4.1 authentication */
	MYSQL_CLIENT_MULTI_STATEMENTS = 65536,      /* Enable/disable multi-stmt support */
	MYSQL_CLIENT_MULTI_RESULTS = 131072,     	  /* Enable/disable multi-results */
	MYSQL_CLIENT_PS_MULTI_RESULTS = 262144,  /* Multi-results in PS-protocol */
	MYSQL_CLIENT_PLUGIN_AUTH = 524288,       /* Client supports plugin authentication */
	MYSQL_CLIENT_CONNECT_ATTRS = 1048576,     /* Client supports connection attributes */

	/* Enable authentication response packet to be larger than 255 bytes. */
	MYSQL_CLIENT_PLUGIN_AUTH_LENENC_CLIENT_DATA = 2097152,

	/* Don't close the connection for a connection with expired password. */
	MYSQL_CLIENT_CAN_HANDLE_EXPIRED_PASSWORDS = 4194304,

	MYSQL_CLIENT_SSL_VERIFY_SERVER_CERT = 1073741824,
	MYSQL_CLIENT_REMEMBER_OPTIONS = 2147483648
};
